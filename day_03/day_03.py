...
def findNearestIntersection(wire1, wire2):
    ...
    # take 1st letter and convert rest to integer
    # make list of lines
    # take intersections of lines
